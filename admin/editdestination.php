    ...
    try {
        if(isset($_FILES['newImage']) && $_FILES['newImage']['error'] === UPLOAD_ERR_OK) {
            ...
            if(move_uploaded_file($newImage['tmp_name'], $imagePath)) {
                $query = "UPDATE destination SET name='$name', price='$price', location='$location', rating='$rating', description='$description', image='$imagePath' WHERE destination_id='$id'";
            } else {
                throw new Exception("Failed to upload image.");
            }
        } else {
            $query = "UPDATE destination SET name='$name', price='$price', location='$location', rating='$rating', description='$description' WHERE destination_id='$id'";
        }
